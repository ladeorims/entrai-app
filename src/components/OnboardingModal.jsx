...
const formInputClasses = "w-full p-3 border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-dark-primary-bg rounded-lg text-text-primary dark:text-dark-text-primary focus:outline-none focus:ring-2 focus:ring-accent-start dark:focus:ring-dark-accent-mid";
...
const OnboardingModal = () => {
    ...
    const handleSave = async () => {
        ...
        if (!onboardingData.primaryGoal) {
            setLocalError('Please select a primary goal.');
            return;
        }
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <Card className="max-w-xl w-full">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="company" className="block text-sm font-bold mb-2">2. What is your company name?</label>
                        <input
                            id="company"
                            type="text"
                            name="company"
                    ...
                    <div>
                        <label htmlFor="primaryGoal" className="block text-sm font-bold mb-2">4. What is your main goal with Entruvi?</label>
                        <select
                            id="primaryGoal"
                            name="primaryGoal"
