// src/components/modals/NewCampaignModal.jsx
...
export const NewCampaignModal = ({ token, onClose, onCampaignAdded }) => {
    ...
    const handleAddCampaign = async (e) => {
        ...
        setIsLoading(true);
        try {
            await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/campaigns`, { 
                method: 'POST', 
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
            <Card className="max-w-lg w-full">
                ...
                <form onSubmit={handleAddCampaign} className="space-y-4">
                    ...
                    <button type="submit" disabled={isLoading} className="w-full bg-gradient-to-r from-accent-start to-accent-end dark:from-dark-accent-start dark:to-dark-accent-end text-white py-3 rounded-lg font-semibold hover:opacity-90 flex items-center justify-center">
