...
// UPDATED: Added text-text-primary and dark:text-dark-text-primary to ensure text is always visible
...
const AuthPage = ({ onAuth, isLoading, authMessage, setAuthMessage, setActiveView }) => {
...
            <style>{`
                ...
                .dark .hero-gradient-text {
                    background: linear-gradient(90deg, #00F2A9, #9B51E0);
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent;
                }
            `}</style>
...
                className="absolute top-6 left-6 flex items-center gap-2 text-sm font-semibold text-text-secondary dark:text-dark-text-secondary mb-4 hover:opacity-80 z-20"
            >
