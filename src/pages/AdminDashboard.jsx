...
const AdminDashboard = ({ token }) => {
                        ...
                        {filteredUsers.map(user => (
                            <tr key={user.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <button className="text-red-500 hover:opacity-70"><Trash2 size={16}/></button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            {editingUser && <UserEditModal user={editingUser} token={token} onClose={() => setEditingUser(null)} />}
