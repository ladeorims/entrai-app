    ...
    return (
        <PublicLayout>
            ...
            <div className="text-center py-20">
                <button onClick={() => navigate('/auth')} className="bg-gradient-to-r from-accent-start to-accent-end text-white font-semibold px-8 py-4 rounded-xl transition shadow-lg hover:opacity-90 text-lg">
