...
const ContactPage = ({ setActiveView, onLaunchApp, onStartTrial }) => {
    return (
        <PublicLayout activeView="Contact" setActiveView={setActiveView} onLaunchApp={onLaunchApp} onStartTrial={onStartTrial}>
