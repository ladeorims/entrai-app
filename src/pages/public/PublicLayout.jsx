    ...
    const navLinks = (
        <>
            ...
            <div className="relative" ref={companyMenuRef}>
                <button onClick={() => setIsCompanyMenuOpen(!isCompanyMenuOpen)} className="flex items-center gap-1 py-2 px-3 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800">
                    Company <ChevronDown size={16} />
                </button>
                {isCompanyMenuOpen && (
                    <div className="absolute top-full mt-2 w-48 bg-card-bg dark:bg-dark-card-bg border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg z-20">
        ...
        <header className="sticky top-0 bg-card-bg/80 dark:bg-dark-card-bg/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 z-50">
            <div className="container mx-auto px-5 py-3.5 flex items-center justify-between max-w-7xl">
                ...
                <nav className="hidden md:flex items-center gap-5 text-text-secondary dark:text-dark-text-secondary font-semibold">
                    ...
                    <button onClick={onStartTrial} className="bg-gradient-to-r from-accent-start to-accent-end dark:from-dark-accent-start dark:to-dark-accent-end text-white font-semibold px-4 py-2 rounded-xl transition shadow-lg hover:opacity-90">Start Free Trial</button>
                </nav>
            ...
            {isMenuOpen && (
                <div className="md:hidden absolute top-full left-0 w-full bg-card-bg dark:bg-dark-card-bg shadow-lg">
                    <nav className="flex flex-col items-center p-4 text-text-secondary dark:text-dark-text-secondary font-semibold">{navLinks}</nav>
                </div>
            )}
        </header>
    );
